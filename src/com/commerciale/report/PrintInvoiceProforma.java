...
public class PrintInvoiceProforma {
	private List<InvoiceProforma> invoices;
	private List<LineProductProforma> lineProducts;
    private List<Client> clients  = new ArrayList<Client>();
    private List<Product> products  = new ArrayList<Product>();
    private List<SaleConditions> conditions;

	public List<InvoiceProforma> Select(String query) {
	...
	public JasperPrint print(String query, String outputFile) throws Throwable {
		...
		lineProducts = invoices.get(0).getLineProductProforma();
		clients.add(invoices.get(0).getClient());
		for (LineProductProforma lp : lineProducts) {
