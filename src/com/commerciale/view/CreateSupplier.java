...
public class CreateSupplier extends JInternalFrame {
	private static CreateSupplier CS = null;
	...
	private JLabel lblNewLabel = new JLabel("Nombre de Fournisseur:");
	private JLabel lblSumSuppier = new JLabel("");
	...
	private CreateSupplier() {
		...
		btnAdd.setLocation(192, 159);
		Container.add(btnAdd);
		btnUpdate.setLocation(339, 159);
		btnUpdate.setSize(126, 30);
		Container.add(btnUpdate);
		btnCancel.setLocation(481, 159);
		btnCancel.setEnabled(false);
		btnCancel.setSize(126, 30);
		Container.add(btnCancel);
		btnSave.setEnabled(false);
		btnSave.setLocation(623, 159);
		...
		lblSumSuppier.setFont(new Font("Times New Roman", Font.PLAIN, 21));
		lblSumSuppier.setHorizontalAlignment(SwingConstants.LEFT);
		lblSumSuppier.setBounds(192, 710, 186, 26);
		Container.add(lblSumSuppier);
		...
		btnDelete.setLocation(770, 159);
		btnDelete.setSize(137, 30);
		btnDelete.setEnabled(true);
		Container.add(btnDelete);
	}
	
	public static CreateSupplier getInstance() {
		if (CS==null) {
			synchronized (CreateSupplier.class) {
				if (CS == null) CS = new CreateSupplier();				
			}
		}
		return CS;
	}
	...
	public String getlblSumSuppier() {
		return lblSumSuppier.getText();
	}
	
	public void setSumSupplier(int sum) {
		lblSumSuppier.setText(String.valueOf(sum));
	}
	...
	public int getShowSupplier() {
		return ShowSupplier;
	}
	public void setShowSupplier(int showSupplier) {
	...
	public void allNeddedWhenOpen(InternalFrameListener frameOpen) {
		CreateSupplier.this.addInternalFrameListener(frameOpen);
	}
}
